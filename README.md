...
- **Peminjaman Barang (loading out / loading in)**: kru mencatat barang yang dibawa ke event dengan foto bukti dari HP (dikompresi di klien, disimpan di basis data), mengembalikannya bertahap, dan menutup dokumen dengan selisih bila ada yang hilang; stok dan jurnal tidak disentuh, Stok per Gudang menampilkan kolom "Di lokasi", kehilangan diselesaikan lewat Penyesuaian Stok yang ditautkan. Foto barang dan kolom warna ikut di data induk Barang
