...
export default async function CashOutPage() {
  ...
  return (
    <div className="space-y-8">
      <h1 className="page-title">Kas Keluar</h1>

      <ActionForm action={createCashOutForm} className="card grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl">
        <div className="field">
        ...
        <div className="field">
          <label className="label">Akun Lawan (tujuan/beban) *</label>
