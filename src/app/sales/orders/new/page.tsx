...
export default async function NewOrderPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <h1 className="text-xl font-semibold">Pesanan Penjualan Baru</h1>

      <ActionForm action={createOrderForm} className="grid grid-cols-1 md:grid-cols-2 gap-4 border rounded-lg p-4">
