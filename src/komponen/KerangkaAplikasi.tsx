 ...
 */
export default function KerangkaAplikasi({ pengguna, namaPerusahaan, children }: { pengguna: PenggunaSesi; namaPerusahaan: string; children: ReactNode }) {
  const [lacaTerbuka, setLacaTerbuka] = useState(false);

  return (
    <div className="min-h-screen bg-canvas">
      <BilahSamping pengguna={pengguna} namaPerusahaan={namaPerusahaan} open={lacaTerbuka} saatTutup={() => setLacaTerbuka(false)} />
