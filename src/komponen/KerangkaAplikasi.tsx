 ...
 */
export default function KerangkaAplikasi({ pengguna, children }: { pengguna: PenggunaSesi; children: ReactNode }) {
  const [lacaTerbuka, setLacaTerbuka] = useState(false);

  return (
    <div className="min-h-screen bg-canvas">
      <BilahSamping pengguna={pengguna} open={lacaTerbuka} saatTutup={() => setLacaTerbuka(false)} />
