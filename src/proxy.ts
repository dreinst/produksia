 ...
 */
const JALUR_PUBLIK = ["/masuk", "/lupa-kata-sandi", "/atur-ulang", "/api/sehat"];
...
export const config = {
  matcher: ["/((?!_next/static|_next/image|favicon\\.ico|manifest\\.webmanifest|.*\\.(?:png|jpg|jpeg|svg|webp|woff2?|ico)$).*)"],
};
